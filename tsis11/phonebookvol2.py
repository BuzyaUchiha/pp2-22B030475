...
connection = psycopg2.connect(host = "localhost", database = "postgres", user = "postgres", password = "12345")
...
def inserting(first_name, last_name, phone_number):
    ...
    if cur.fetchone()[0]==0:
         cur.execute("""INSERT INTO Phonebook VALUES ('{}','{}', {})""".format(first_name, last_name, phone_number))
    else:
...
print('5)Delete data from tables by phone')
num = int(input())
